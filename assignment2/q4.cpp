...
template <typename elem>
void linktree<elem>::maketree(dlist<elem>& l){
...
int main(){
	...
	ofstream output;
	output.open("2015csb1021-output4.txt", ios::out | ios::trunc);
	...
	while(getline(input,line)){
		...
		input_tree.maketree(input_list);
		...
		output<<input_tree.height(input_tree.root)<<" ";
